...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=KhaoNiawThin&amp;family=KhaoNiawThin:wght@300;400;500&amp;display=swap"
        rel="stylesheet">
</head>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-2">
                            ...
                            <div thumbsslider=""
                                ...
                                <div class="swiper-wrapper" id="swiper-wrapper-e895cb2156176c41" aria-live="polite"
                                    style="transform: translate3d(0px, 0px, 0px);">
                                    <div class="swiper-slide swiper-slide-visible swiper-slide-active swiper-slide-thumb-active"
                                        style="width: 202.667px; margin-right: 8px;" role="group" aria-label="1 / 4">
                                        <img src="images/item8.jpg" class="img-fluid">
                                    </div>
                                    <div class="swiper-slide swiper-slide-visible swiper-slide-next"
                                        style="width: 202.667px; margin-right: 8px;" role="group" aria-label="2 / 4">
                                        <img src="images/item4.jpg" class="img-fluid">
                                    </div>
                                    <div class="swiper-slide swiper-slide-visible"
                                        style="width: 202.667px; margin-right: 8px;" role="group" aria-label="3 / 4">
                                        <img src="images/item7.jpg" class="img-fluid">
                                    </div>
                                    <div class="swiper-slide" role="group" aria-label="4 / 4"
                                        style="width: 202.667px; margin-right: 8px;">
                ...
                <div class="col-lg-6 mt-5 ">
                    <div class="product-info">
                        ...
                        <div class="product-price pt-3 pb-3">
                            <strong class="text-primary display-6 fw-bold">$170.00</strong><del
                                class="ms-2">$240.00</del>
                        </div>
                ...
                <div class="d-flex flex-column flex-md-row align-items-start gap-5">
                    <div class="nav flex-row flex-wrap flex-md-column nav-pills me-3 col-lg-3" id="v-pills-tab"
                        ...
                        <button class="nav-link fs-5 mb-2 text-start" id="v-pills-reviews-tab" data-bs-toggle="pill"
                            ...
                            aria-selected="false" tabindex="-1">Customer Reviews</button>
                    </div>
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="v-pills-additional" role="tabpanel"
                            ...
                            <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat
                                ...
                                mollit anim id est
                                laborum. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu
                                fugiat nulla
