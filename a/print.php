...
<body>
    <?php
    $sql_data = "SELECT * FROM `transale` INNER JOIN paper_user ON  `transale`.`US_ID` = paper_user.US_ID WHERE transale.id_transale  = '{$_GET['ID']}'";
            ...
            <div class="subpage">
                <div class="row">
                    ...
                    <div class="col-5 text-left">
                        ...
                        <p><?php echo $transale->US_FNAME . " " . $transale->US_LNAME; ?></p>
                        <p>ติดต่อ <?php echo $transale->US_PHONE ?></p>
